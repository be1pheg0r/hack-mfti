...
DEFAULT_SBER_SCRIPT_ENABLE_AUTO_SUBPROCESS: bool = True
DEFAULT_SBER_SCRIPT_SUBPROCESS_MAX_WORKERS: int = 2
DEFAULT_SBER_SCRIPT_SUBPROCESS_MIN_FREE_GPU_MEMORY_MIB: int = 40000
